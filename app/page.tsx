            ...
            <div className="grid md:grid-cols-2 gap-6 mb-4">
              <div className="bg-gray-900/80 rounded-lg p-5 border-l-4 border-green-500">
                ...
                <ul className="space-y-2 text-gray-200">
                  ...
                  <li className="flex items-start">
                    <span className="text-green-400 mr-2">•</span>랙 포지션에서
                    오버헤드 방식은 자유롭게 선택 가능합니다.
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-400 mr-2">•</span>
          ...
          <div className="mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-4">
              <div className="bg-gray-900/80 rounded-lg p-5 border-l-4 border-green-500">
                ...
                <ul className="space-y-2 text-gray-200">
                  <li className="flex items-start">
                    <span className="text-green-400 mr-2">•</span>각 런지 구간은
                    라인 뒤에 양발이 일렬로 서서 시작합니다.
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-400 mr-2">•</span>
                    뒷발 무릎이 바닥에 닿아야 합니다.
      ...
      return (
        <div className="bg-gray-800/80 backdrop-blur-md p-10 rounded-xl shadow-xl border border-blue-500/30 text-center">
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="text-4xl font-bold text-blue-200 mb-4">
              Coming Soon
            </h3>
            <p className="text-gray-300 max-w-md">
              워크아웃 {activeTab}는 아직 공개되지 않았습니다. 곧 공개될
              예정이니 조금만 기다려주세요!
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-6xl mb-12">
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            >
              <div
                className={`rounded-md p-4 h-full flex flex-col items-center justify-center ${
                  activeTab === "25.1" ? "bg-gray-900" : "bg-gray-800"
                }`}
              >
                <h2
                  className={`text-3xl font-bold mb-1 ${
                    activeTab === "25.1" ? "text-white" : "text-gray-300"
                  }`}
                >
                  25.1
                </h2>
                <p
                  className={`text-sm ${
                    activeTab === "25.1" ? "text-blue-300" : "text-blue-200/70"
                  }`}
                >
                  현재 공개
                </p>
            ...
            >
              <div
                className={`rounded-md p-4 h-full flex flex-col items-center justify-center ${
                  activeTab === "25.2" ? "bg-gray-900" : "bg-gray-800"
                }`}
              >
                <h2
                  className={`text-3xl font-bold mb-1 ${
                    activeTab === "25.2" ? "text-white" : "text-gray-300"
                  }`}
                >
                  25.2
                </h2>
                <p
                  className={`text-sm ${
                    activeTab === "25.2" ? "text-blue-300" : "text-blue-200/70"
                  }`}
                >
                  Coming Soon
                </p>
            ...
            >
              <div
                className={`rounded-md p-4 h-full flex flex-col items-center justify-center ${
                  activeTab === "25.3" ? "bg-gray-900" : "bg-gray-800"
                }`}
              >
                <h2
                  className={`text-3xl font-bold mb-1 ${
                    activeTab === "25.3" ? "text-white" : "text-gray-300"
                  }`}
                >
                  25.3
                </h2>
                <p
                  className={`text-sm ${
                    activeTab === "25.3" ? "text-blue-300" : "text-blue-200/70"
                  }`}
                >
                  Coming Soon
                </p>
